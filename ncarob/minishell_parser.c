...
/*   Updated: 2022/03/04 21:44:55 by ncarob           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* 
We can break the loop when the variable is found.
However the func takes more than 25 lines of code with that.
------>
*/

static char	*ft_replace_path(char *str, int *index, t_env_vars *envs)
{
	char	*value;
	int		i;
...
static char	*ft_pre_parsing(char *str, int *index, char quote, t_env_vars *envs)
{
	int		i;
	char	*tmp[3];
...
int	ft_parse_input(char *s, t_env_vars *envs)
{
	int		i;
	char	*str;
